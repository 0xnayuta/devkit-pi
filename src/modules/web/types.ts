...
export type DetectedContentType = "html" | "markdown" | "json" | "csv" | "xml" | "yaml" | "text" | "unsupported";
...
export type StoredResult = { type: "fetch"; urls: ExtractedContent[] } | { type: "search"; queries: QueryResultData[] };
