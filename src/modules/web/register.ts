 ...
 */
export function registerWebTools(pi: ExtensionAPI, config: ResolvedWebConfig, options: { logger?: Logger } = {}): void {
	...
	pi.registerTool(
		defineTool({
			...
			renderCall(args: WebSearchInput, theme) {
				return renderWebSearchCall(args, theme as WebRenderTheme);
			},
			renderResult(result: AgentToolResult<unknown>, options: { expanded: boolean; isPartial: boolean }, theme) {
				return renderWebSearchResult(result, options, theme as WebRenderTheme);
			},
		})
	);
	...
	pi.registerTool(
		defineTool({
			...
			renderCall(args: FetchContentInput, theme) {
				return renderFetchContentCall(args, theme as WebRenderTheme);
			},
			renderResult(result: AgentToolResult<unknown>, options: { expanded: boolean; isPartial: boolean }, theme) {
				return renderFetchContentResult(result, options, theme as WebRenderTheme);
			},
		})
	);
	...
	pi.registerTool(
		defineTool({
			...
			renderCall(args: GetSearchContentInput, theme) {
				return renderGetSearchContentCall(args, theme as WebRenderTheme);
			},
			renderResult(result: AgentToolResult<unknown>, options: { expanded: boolean; isPartial: boolean }, theme) {
				return renderGetSearchContentResult(result, options, theme as WebRenderTheme);
			},
		})
	);
}
