...
export function detectClangdCompilationDatabaseSetting(root: string): { none: true } | { dir: string } | undefined {
...
export interface LSPServerConfig {
	...
	spawn: (
		root: string
	) => Promise<{ process: ChildProcessWithoutNullStreams; initOptions?: Record<string, unknown> } | undefined>;
}
