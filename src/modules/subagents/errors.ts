...
const SUBAGENT_REMEDIATION_MAP: Record<SubagentErrorCode, string | undefined> = {
  ...
  SUBAGENT_DEPTH_EXCEEDED:
    "Reduce nesting depth or increase subagents.maxDepth if your workflow requires it.",
  ...
  SUBAGENT_OUTPUT_TRUNCATED:
    "Reduce output volume, split the task, or increase subagent output limits.",
};
