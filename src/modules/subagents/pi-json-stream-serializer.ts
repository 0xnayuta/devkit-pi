...
export function serializePiJsonStreamEvent(event: unknown, profile: PiJsonStreamProfile): unknown | undefined {
...
function pickDefined(record: Record<string, unknown>, keys: readonly string[]): Record<string, unknown> {
