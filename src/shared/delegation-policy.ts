/**
 * Delegation Policy Injection
 *
 * Provides the system prompt additions that guide the main agent
 * to delegate focused tasks to specialized subagents.
 *
 * TODO: Phase 2 — migrate from pi-subagents/src/shared/delegation-policy.ts
 */

export const DELEGATION_POLICY = `## Subagent Delegation Policy
...
export const DELEGATION_EXAMPLES = `## Delegation Examples
