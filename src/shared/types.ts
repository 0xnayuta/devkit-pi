...
export type WebSearchProviderName = "auto" | "brave" | "ddgs" | "openserp" | "searxng" | "tavily" | "serper";
...
export function truncateOutput(output: string, config: Required<MaxOutputConfig>): TruncationResult {
