...
import { createPinnedLookup, fetchWithPinnedDns, resolveAndValidateAddresses } from "../../src/modules/web/network.ts";
...
describe("web/network createPinnedLookup", () => {
	...
	it("rejects hostname mismatch", () => {
		const lookup = createPinnedLookup(new URL("https://example.com/path"), [{ address: "93.184.216.34", family: 4 }]);
